 ...
 * @LastEditTime: 2020-05-04 02:39:09
 ...
 */
 ...
 (
    ...
    reg [0:FRAME_WIDTH - 1]                 din_temp;   // used to register input parallel data temporarily
            ...
            case(state)
                IDLE : begin
                    if(uart_tx_en) begin
                        ...
                        din_temp <= uart_tx_din;
                        state <= INIT; // state transition
                    end
                end
                INIT : begin
                    shift_reg <= {parity_bit, din_temp}; // load parallel data (including parity) into shifter registers
                    counter <= 0;

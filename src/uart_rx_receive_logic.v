 ...
 * @LastEditTime: 2020-05-03 04:27:55
 ...
 */
 ...
 (
    ...
    reg                     din_delay1;         // used for negedge detection
    reg                     din_delay2;         // used for negedge detection
    reg                     din_delay3;         // used for negedge detection
    ...
    always @(posedge sample_clk, posedge reset) begin
        if(reset) begin
            ...
            din_delay1 <= uart_rx_din;
            din_delay2 <= din_delay1;   // two clock synchronizer
            din_delay3 <= din_delay2;
        end
    end
    assign  negedge_detect  =   (~din_delay2) & din_delay3;
